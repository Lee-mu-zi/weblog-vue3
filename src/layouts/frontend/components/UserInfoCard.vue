<template>
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            <!-- 博主头像 -->
            <img class="w-20 h-20 mb-3 rounded-full shadow" :src="blogSettingsStore.blogSettings.avatar" />
            <!-- 博主昵称 -->
            ...
            <div class="flex justify-center gap-2">
                ...
                <svg v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662"
                    ...
                    height="200" @click="jump(blogSettingsStore.blogSettings.githubHomepage)">
