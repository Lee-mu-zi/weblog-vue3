    ...
    <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
        <div class="flex flex-col items-center">
            ...
            <div class="relative mb-5">
                <img class="w-20 h-20 rounded-full shadow" :src="blogSettingsStore.blogSettings.avatar" />
                <span
                    class="bottom-0 left-14 absolute w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
            </div>

            <!-- 博主昵称 -->
            <h5 class="mb-5 text-xl font-medium text-gray-900 dark:text-white">{{ blogSettingsStore.blogSettings.author
                }}</h5>
            <!-- 介绍语 -->
            ...
            <div class="flex justify-center gap-2">
                ...
                <svg v-if="blogSettingsStore.blogSettings.githubHomepage" t="1698029949662"
                    ...
                    class="hover:scale-110 icon  w-7 h-7" viewBox="0 0 1024 1024" version="1.1"
