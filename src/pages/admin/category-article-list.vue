<template>
    ...
    <div v-if="articles && articles.length > 0" style="width: 100%; height: 2.5em; background-color: white;"
        class="flex items-center font-semibold pl-2">{{
        categoryName }}</div>

    <el-table v-if="articles && articles.length > 0" :data="articles" border stripe style="width: 100%"
        v-loading="tableLoading">
        <el-table-column prop="id" label="ID" width="180" />
        <el-table-column prop="title" label="文章名称" width="100" />
        ...
        <svg height="300" node-id="1" sillyvg="true" template-height="600" template-width="600" version="1.1"
            ...
            <defs node-id="58">
                ...
                <linearGradient gradientUnits="objectBoundingBox" id="linearGradient-2" node-id="8" spreadMethod="pad"
                    x1="1.4458808" x2="0.29515958" y1="0.670017" y2="0.67419773">
                    <stop offset="0" stop-color="#e0e5ef" stop-opacity="0" />
                    <stop offset="1" stop-color="#e0e5ef" />
                </linearGradient>
                ...
                <linearGradient gradientUnits="objectBoundingBox" id="linearGradient-5" node-id="17" spreadMethod="pad"
                    x1="0.5" x2="0.5" y1="1" y2="-0.268682">
            ...
            <g node-id="89">
                <path
                    ...
                    fill="#f3f3fa" fill-opacity="0.6015942" fill-rule="evenodd" group-id="1" id="背景" node-id="21"
                    stroke="none" target-height="442" target-width="543" target-x="29" target-y="77" />
            </g>
            <path
                ...
                fill="url(#linearGradient-1)" fill-rule="nonzero" id="路径" node-id="22" stroke="none" target-height="53"
                target-width="90.034676" target-x="121.93691" target-y="154.4683" />
            <path
                ...
                fill="url(#linearGradient-2)" fill-rule="nonzero" id="路径" node-id="23" stroke="none" target-height="38"
                target-width="64.379456" target-x="381" target-y="135" />
            <path
            ...
            <path
                ...
                fill="url(#linearGradient-3)" fill-rule="nonzero" group-id="2" id="路径" node-id="27" stroke="none"
            ...
            <path
                ...
                fill="url(#linearGradient-3)" fill-rule="nonzero" group-id="2" id="路径" node-id="28" stroke="none"
            ...
            <path
                ...
                fill="url(#linearGradient-4)" fill-rule="nonzero" group-id="2" id="路径" node-id="29" stroke="none"
            ...
            <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="31" stroke="none" target-height="146"
                target-width="160" target-x="164" target-y="263" />
            ...
            <path d="M 151.00 331.00 L 341.00 331.00 L 323.73 439.00 L 168.27 439.00 Z" fill="url(#linearGradient-5)"
                fill-rule="nonzero" group-id="3" id="矩形" node-id="35" stroke="none" target-height="108"
                target-width="190" target-x="151" target-y="331" />
            <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="36" stroke="none" target-height="7"
                target-width="7" target-x="261" target-y="378" />
            <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形" node-id="37" stroke="none" target-height="7"
                target-width="31" target-x="275" target-y="378" />
            <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="矩形备份-2" node-id="38" stroke="none" target-height="7"
                target-width="45" target-x="260" target-y="393" />
            <path
                ...
                fill="#d9dfe8" fill-rule="evenodd" group-id="3" id="椭圆形" node-id="39" stroke="none" target-height="30"
                target-width="30" target-x="221" target-y="241" />
            <path
            ...
            <path
                ...
                fill="#c0c9db" fill-rule="evenodd" group-id="3" id="椭圆形" node-id="41" stroke="none" target-height="64"
                target-width="64" target-x="312" target-y="223" />
            <path
                ...
                fill="#ffffff" fill-rule="nonzero" group-id="3" id="形状" node-id="42" stroke="none" target-height="34"
                target-width="20" target-x="334" target-y="238" />
            <path
                ...
                target-height="36.924408" target-width="22.992584" target-x="368.0036" target-y="310.04767" />
            <path
            ...
            <path
                ...
                target-height="29.987915" target-width="26.985718" target-x="358.01428" target-y="351.9996" />
            <path
            ...
            <path
                ...
                target-height="19.704224" target-width="24.921417" target-x="408.91635" target-y="360.7389" />
            <path
                ...
                target-height="87.49216" target-width="11.486877" target-x="386.2541" target-y="337.11166" />
            <path
                ...
                target-height="89.92609" target-width="20.01233" target-x="388.90866" target-y="334.14902" />
            <path
                ...
                target-height="71.930725" target-width="19.96933" target-x="397.0023" target-y="353.03717" />
            <path
            ...
            <path
                ...
                target-height="56.921204" target-width="17.021759" target-x="375.567" target-y="366.60376" />
            <path
                ...
                target-height="37.964294" target-width="13.975433" target-x="394.0235" target-y="382.03568" />
            <path
                ...
                fill="#d1d6e2" fill-rule="nonzero" group-id="4" id="矩形" node-id="55" stroke="none" target-height="5"
                target-width="33" target-x="380" target-y="467" />
            <path
                ...
                fill="#c0c7d2" fill-rule="evenodd" group-id="4" id="矩形" node-id="56" stroke="none" target-height="46"
                target-width="33.334473" target-x="380.8566" target-y="423" />
        </svg>
...
import { getArticlesByCategory } from '@/api/admin/article'
...
function getArticles() {
    getArticlesByCategory({ categoryName: categoryName.value })
        .then((res) => {
            if (res.success == true) {
